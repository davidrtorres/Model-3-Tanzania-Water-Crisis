...
2.  Scrubbed the data.  There were 3 main issues with the data that needed to be addressed:
    ...
    Feature categories with value of 0.  If the 0 value constituted a large percentage of the of feature I dropped the feature.  However, in some instances like         construction which 0 was 34% of the values I imputed the median value of the feature for the 0 value. 
